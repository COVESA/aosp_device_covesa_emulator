...
We need to rename and host the `zip` files generated by `m emu_img_zip` command with respective lunch targets, along with [./covesa-sys-img2-1.xml] description of all emulator system images we provide.

[./covesa-sys-img2-1.xml] has to be adjusted to provide correct file information, for example:
...
* Consider providing prebuilt AVD configurations for easy import in Android Studio.
  ...
  See `device/generic/car/tools/README.md` and `device/generic/car/tools/x86_64/devices.xml`
